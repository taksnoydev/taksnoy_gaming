...
import {youtubeLink, instagramLink, uploadLink} from "../Constants";
    ...
    return (
        <div className="Footer">
            <div className="Footer__information">
                <a href="/">Home</a>
                <a href={uploadLink} target="_blank">Upload</a>
                <a href="/contact">Contact</a>
                <a href="/terms">Terms</a>
                <a href="/privacy">Privacy</a>
            </div>
            <div className="Footer__social-media">
                <a href={youtubeLink} target="_blank"><YoutubeIcon/></a>
                <a href={instagramLink} target="_blank"><InstagramIcon/></a>
            </div>
            <p>Taksnoy Brawlstars &copy; 2020</p>
